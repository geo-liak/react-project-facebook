    ...
    <>
      ...
      <div className=" panel panel-default">
        ...
        <div className="panel-footer">
          <button onClick={handleLikeClick} id='like' className="btn btn-default col-sm-4 btn-outline-secondary mb-3">Like</button>
          <button id='comment' className="pull-right col-sm-4 btn btn-outline-secondary mb-3">Comment</button>
          <button id='share' className="pull-right col-sm-4 btn btn-outline-secondary mb-3">Share</button>
        </div>
      </div>
